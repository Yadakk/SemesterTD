...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        combinedBounds = gameObject.CalculateBounds();
    }
    ...
    public void SetCurrentNode(UnitPathNode node)
    {
        ...
        currentNodePosition = combinedBounds.GetPositionOnTop(currentNode.GetComponent<Collider>().bounds);
        targetNodePosition = combinedBounds.GetPositionOnTop(targetNode.GetComponent<Collider>().bounds);
